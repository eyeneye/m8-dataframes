...
setwd("~/Documents/School/Fall2016/INFO201/m8-dataframes/exercise-6/")
...
MostPopular <- function(x) {
  propyear <- prop[which(year == x)]
  return (name[prop == max(propyear)])
}
MostPopular(2013)
# What was the most popular female name in 1994?

most.pop1994 <- MostPopular(1994)
most.pop1994
### Bonus ###
