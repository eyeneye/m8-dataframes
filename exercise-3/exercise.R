...
salaries[57, 'salaries2015']

# How many employees got a raise?

nrow(salaries[salaries$got.raise == TRUE,]) # we put a comma after true, but we don't want to specify
#columns so we dont leave anything there
